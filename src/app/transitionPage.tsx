...
import { rightSections, flexColSpaceBetweenDiv, nameStyle, jobPositionStyle, iconStyle } from './style/constantStyles';
...
export default function TransitionPage() {
  ...
  return (
    <>
      <div className='app flex flex-row mx-auto min-h-screen max-w-screen-xl px-24 font-sans'>
        <div className='basis-1/3 sticky gap-4 flex flex-col justify-between max-h-screen top-0 py-14'>
          ...
          <div className='social-media flex flex-row gap-3'>
